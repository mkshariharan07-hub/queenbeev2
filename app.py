...
# SIDEBAR
# ==========================================
confidence = st.sidebar.slider("Confidence Threshold", 0.1, 1.0, 0.45)
...
if image is not None and st.button("🚀 Run Detection"):
    ...
    col_m1.metric("Total Weeds Found", len(detected))
    col_m2.metric("Detection Confidence", f"{confidence*100:.0f}%")
